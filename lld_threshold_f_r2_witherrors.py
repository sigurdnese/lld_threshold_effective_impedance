...
np.savetxt(f'errors/errors_fixed_Q_2_{Q_2_array[0]}_f_hom_{f_hom}_lenf_r2_{len(f_r2_array)}.txt',np.column_stack([f_r2_array/f_r,errors_fixed]))
np.savetxt(f'errors/errors_adaptive_{adaptive_mode_name}_Q_2_{Q_2_array[0]}_f_hom_{f_hom}_lenf_r2_{len(f_r2_array)}.txt',np.column_stack([f_r2_array/f_r,errors_adaptive]))
...
plt.tight_layout()
# plt.savefig(f'Figures/MELODY_comparison/lxplus/comparison_{timestamp}.pdf')
plt.show()
