...
omega_0 = 2*np.pi*f_0
# Zotter, Gaussian line distribution
...
# Zotter, parabolic line distribution
...
plt.plot(f_r2_array/f_r,parabolic_zeff_array,label='Parabolic Zotter')
plt.plot(f_r2_array/f_r,gaussian_zeff_array,label='Gaussian Zotter')
plt.title(f'$Q_2={Q_2}$')
